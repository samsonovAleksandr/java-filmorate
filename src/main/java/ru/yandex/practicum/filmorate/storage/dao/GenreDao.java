...
public class GenreDao {
    ...
    // Без этого метода неполучается подругому поменять кодировку что бы выводило русские символы :(
    // Файл data.sql в формате UTF-8, менял на другие кодировки - непомогло.
